...
public class Insertar {
    ...
    public int insertarPadre(String nombre_padre, String telefono, String direccion, String email, String comentario) {
        ...
        try {
            sSQL = "INSERT INTO defaultdb.Padre (nombre_padre,telefono, direccion, email, comentario) VALUES(?,?,?,?,?);";
    ...
    public void insertarHijo(int id_padre, String nombre_apellido, LocalDate fecha_nacimiento, String colegio,
            ...
            int auth_imagenes) {
        try {
            sSQL = "INSERT INTO defaultdb.Hijo (id_padre,nombre_apellido, fecha_nacimiento, colegio, curso, discapacidad, derivacionss,derivacion_gadir,auth_actividades,auth_imagenes) VALUES(?,?,?,?,?,?,?,?,?,?);";
